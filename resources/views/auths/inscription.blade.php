				...
				<form method="post" action="/inscription">
					...
					<div class="row">
						<div class="input-field col s10 offset-s1">
							...
							<label for="mot_de_passe_confirmation" class="active">Confirmation du mot de passe</label>
						</div>
					</div>
					...
					<div class="row">
						<div class="input-field col s10 offset-s1">
							<input id="date_de_naissance" type="date" name="date_de_naissance" class="validate">
							<label for="date_de_naissance" class="active">Date de naissance</label>
						</div>
					</div>

					<div class="row">
						<div class="input-field col s10 offset-s1">
							<input id="niveau" type="text" name="niveau" class="validate">
							<label for="niveau" class="active">Niveau d'instruction</label>
						</div>
					</div>

					<div class="row">
						<div class="input-field col s10 offset-s1">
							<input id="etablissement" type="text" name="etablissement" class="validate">
							<label for="etablissement" class="active">Etablissement actuel</label>
						</div>
					</div>
